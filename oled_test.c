...
//*****************************************************************************
void helloworld(){
    drawChar(0, 64, 'C', BLUE, BLUE, 2);
    drawChar(10, 64, 'a', BLUE, BLUE, 2);
    drawChar(20, 64, 'm', BLUE, BLUE, 2);
    drawChar(30, 64, 'i', BLUE, BLUE, 2);
    drawChar(40, 64, 'l', BLUE, BLUE, 2);
    drawChar(60, 64, 'a', BLUE, BLUE, 2);
    drawChar(70, 64, 'E', BLUE, BLUE, 2);
    drawChar(80, 64, 'l', BLUE, BLUE, 2);
    drawChar(90, 64, 'b', BLUE, BLUE, 2);
    drawChar(100, 64, 'e', BLUE, BLUE, 2);
    drawChar(110, 64, 'r', BLUE, BLUE, 2);
    drawChar(120, 64, 't', BLUE, BLUE, 2);
}
//*****************************************************************************
void horizontal(){
    fillRect(0, 0, 16, 128, BLUE);
    fillRect(16, 0, 16, 128, BLUE + 67);
